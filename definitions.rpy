...
define s = DynamicCharacter('s_name', image='raiden', what_prefix='"', what_suffix='"', ctc="ctc", ctc_position="fixed")
define m = DynamicCharacter('m_name', image='armstrong', what_prefix='"', what_suffix='"', ctc="ctc", ctc_position="fixed")
define n = DynamicCharacter('n_name', image='bladewolf', what_prefix='"', what_suffix='"', ctc="ctc", ctc_position="fixed")
define y = DynamicCharacter('y_name', image='sam', what_prefix='"', what_suffix='"', ctc="ctc", ctc_position="fixed")
