label sam_exclusive_1:
    ...
    y "Well..."
    y "Mmm..."
    "Sam closes the book and scans her eyes over the back."
    ...
    y "Ahaha."
    "Sam gently giggles, all of a sudden."
    ...
    y "They challenge you to look at life from a strange new perspective."
    y "When horrible things happen not just because someone wants to be evil..."
    y "But because they have their own goals, or their own philosophy that they believe in."
    ...
    y "Uuuh, that's so embarrassing that you think that..."
    mc "W-Wait!"
    ...
    show sam zorder 3 at f11
    y "Ah..."
    "Sam exhales, spared from finishing her thought."
    show sam zorder 2 at t11
    show armstrong zorder 3 at f31
    m 1 "Is that alright, Sam?"
    ...
    hide armstrong
    "Sam releases her hand from the book, causing it to close on top of my thumb."
    mc "Alright..."
...
label sam_exclusive_2_ch3:
    ...
    show sam     mc "Eh?"
    mc "We're just...Sam was going to make some tea, so..."
    "I suddenly realize how weird it sounds to explain this to Armstrong."
    mc "We're just filling the water pitcher..."
    show armstrong zorder 3 at f31
    m "Ah, okay!"
    m "Sorry, I was just a bit curious..."
    m "That's kind of a one-person job, isn't it?"
    show armstrong zorder 2 at t31
    mc "That's--"
    show sam zorder 3 at f11
    y "Armstrong, please mind your own business for once."
    ...
    show sam zorder 2 at t11
    mc "Ah..."
    "Sam quickly exits the room, and I follow."
    ...
    mc "It's also not right for Armstrong to judge people like that."
    play music t9
    y "[player]..."
    ...
    show sam zorder 1 at thide
    hide sam
    "Sam and I walk to the nearest water fountain."
    ...
    "It's a bag of small chocolate candies that I kept hidden from raiden's candy radar."
    ...
    "Sam tries to return to the book."
    ...
    "But this time, Sam's eyes meet mine."
    show y_cg2_exp3
    y "..."
    "How did it even come to this...?"
    "Sam doesn't avert her gaze."
    "I notice her chest rising and falling to the rhythm of her breaths."
    "I raise my arm..."
    y "Ah..."
    "Like before, Sam parts her lips."
    ...
    window show(None)
    window auto
    show armstrong zorder 2 at l31
    m "Okay, everyone!"
    mc "Uwa--"
    show sam zorder 2 at t11
    y "A-Ah!"
    ...
    m "[player], you can help Sam put away the tea stuff, right?"
    show armstrong zorder 2 at t31
    mc "Y-Yeah...of course."
    show armstrong zorder 3 at f31
    m "Okay, thanks!"
    ...
    show sam zorder 1 at thide
    hide sam
    "Sam picks up the teacups from the floor."
