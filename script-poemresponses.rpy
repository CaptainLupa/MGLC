label poemresponse_start:
    ...
    label poemresponse_start2:
        ...
        menu:
            ...
            "Raiden" if not s_readpoem and persistent.playthrough == 0:
                $ s_readpoem = True
                if chapter == 1 and poemsread == 0:
                    "I'm definitely most comfortable sharing it with raiden first."
                    "She's my good friend, after all."
                call poemresponse_raiden
            "Bladewolf" if not n_readpoem:
                $ n_readpoem = True
                if chapter == 1 and poemsread == 0:
                    "I told Bladewolf I was interested in her poems yesterday."
                    "It's probably only fair if I shared mine with her first."
                call poemresponse_bladewolf
            "Sam" if not y_readpoem and not y_ranaway:
                $ y_readpoem = True
                if chapter == 1 and poemsread == 0:
                    "Sam seems the most experienced, so I should start with her."
                    "I can trust her opinion to be fair."
                call poemresponse_sam
            "Armstrong" if not m_readpoem:
                $ m_readpoem = True
                if chapter == 1 and poemsread == 0:
                    "I should start with Armstrong."
                    "Yesterday she seemed eager to read my poem, and I want her to know I'm putting in effort."
                call poemresponse_armstrong
        $ poemsread += 1
...
label ch1_y_end:
    ...
    mc "Not at all."
    y "I'm...really glad you like it."
    y "I'll be honest..."
    y "Since it's our first time sharing, I wanted to write something a little more mild."
    y "Something easy to digest, I suppose."
    mc "Are you into ghosts, Sam?"
    y "Huhu."
    y "Actually, the story isn't about a ghost at all, [player]."
    mc "Really?"
    mc "I must have totally missed the point..."
    y "Well, I suppose you did only glance over it, after all..."
    y "But remember that poets often express their own thoughts, feelings, and experiences in their work."
    y "They usually do more than tell a simple story, or paint a picture."
    y "In this case, perhaps the subject of the poem is only being symbolically compared to a ghost."
    y "Lingering in her last remaining place of comfort, unable to let go of the past."
    ...
    if poemopinion == "good":
        ...
        y "Just remember that it won't be long before you pick up on these things, too."
...
label ch2_y_end:
    ...
    y "It's those sorts of things I'm usually forced to keep to myself."
    y "So, I sometimes enjoy writing about them."
    if n_readpoem and (n_poemappeal[0] >= 0 or n_poemappeal[1] >= 0):
        mc "Huh, that's funny..."
        y "...?"
        mc "Didn't Bladewolf also write something about that?"
        ...
        y "That's...well, that's interesting..."
        ...
        y "Ah-- Please don't tell her I said that!"
        mc "Ahaha. Don't worry, I have no reason to."
        y "Okay..."
        y "Well, thank you for sharing it with me."
    else:
        ...
        y "I feel like everyone has a little something like that."
    ...
    y "After all, if I hadn't learned to embrace my own weirdness, I would probably hate myself."
    y "I-I might be ranting a little bit now..."
    y "...But I'm glad that you're a good listener."
    if y_appeal >= 2:
        y "You're good at a lot of things..."
        y "Writing, listening..."
        y "There really aren't many people like you, [player]..."
        mc "Th-That's exaggerating a little bit..."
        y "It's just...how I feel."
        y "I never thought I would feel so comfortable sharing my writing..."
        y "But now, I almost feel like I look forward to it..."
        y "It's just...a really nice feeling."
        y "And you're to thank for that."
        mc "It's...it's nothing, really..."
        "Sam smiles sincerely at me."
...
label ch3_y_end:
    ...
    if not n_read3 or n_appeal >= 3:
        ...
        y "Oh, you haven't heard...?"
        y "After yesterday, Bladewolf and I...well..."
        y "It was...amusing that we wrote about something similar in such different ways."
        y "So, Bladewolf wanted us to write about the same topic as each other again."
        if n_readpoem:
            if not n_read3:
                mc "I see..."
                "Bladewolf didn't even let me read her poem, so I don't have much to contribute."
            else:
                mc "I see..."
                "Something tells me the poem Bladewolf showed me isn't the one she plans on sharing with everyone else..."
                "Of course, I choose not to mention that to Sam."
    else:
        mc "Yeah, Bladewolf already told me about it."
        y "S-She did...?"
        y "She didn't say anything weird, did she?"
        y "She just wanted us to write about the same topic again..."
    y "I suppose to better compare the differences in our writing styles...or thought processes."
    y "Anyway, it was her idea...!"
    y "Knowing her, it's no surprise that she'd want to do something like that."
    y "She probably just wants to show off."
    y "It's not like I have a particular interest in her writing style..."
    y "I just went with her request."
    y "But..."
    y "Well, I suppose it's not so bad to write about something simple on occasion."
    y "It can be refreshing, you know?"
...
label ch3_y_end_special:
    call showpoem (poem_y3b, img="b")
    "Finishing the poem, I start to hand it back to Sam."
    "But instead of taking it from me, she looks away."
    y "..."
    y "Do you...dislike it?"
    mc "Ah--no, of course not."
    mc "I just...don't really know how I should respond."
    "Despite Sam's poems usually being cryptic, it wasn't hard to figure out what this one was about."
    if n_read3:
        "Also, this clearly isn't the poem that Bladewolf said she wrote about..."
        "...Meaning I'm probably the only one she's showing this to."
    y "I-I don't know if I'll be able to explain this one..."
    mc "That's fine."
    mc "I understand this one."
    y "..."
    "Sam is having an even harder time speaking than usual."
    ...
    show sam     "Despite my inability to make eye contact, I see a faint smile emerge on Sam's lips."
    "I once again try to hand the poem back to her."
    show sam     "But instead, Sam gently takes my hands and pushes them back toward me."
    "I hesitate in response to her warm touch."
    y "You can..."
    y "Um..."
    y "The poem is..."
    "Once again, Sam fails to form a complete sentence."
    mc "You mean I can keep it?"
    "Sam nods."
    mc "I'd love to."
    show sam     "Again, Sam faintly smiles, as if she doesn't want me to notice."
    y "You always..."
    ...
    "Sam finally turns back toward me."
    y "I guess...we should move on before Armstrong says something."
    y "But I'm sure we can talk again later..."
    mc "Yeah."
    mc "I'm sure we will."
    "With that, Sam timidly smiles at me, and I return to my seat so I can put her poem away."
    return

label ch1_n_end:
    call showpoem (poem_n1, img="s")
    n "Yeah..."
    ...
    n "So people don't even take my writing seriously."
    ...
    n "But the other nice thing about simple writing is that it puts more weight on the wordplay."
    ...
    "I don't really care how old everyone is, but if Bladewolf is feeling proud then I won't take that away from her."
    return
...
label ch2_n_end:
    ...
    n "Of course. It's about how everyone thinks my--"
    ...
    if y_readpoem and (y_poemappeal[0] >= 0 or y_poemappeal[1] >= 0):
        mc "Huh, that's funny..."
        mc "Sam wrote about something similar today."
        n "Huh?"
        n "Did you say Sam?"
        mc "Yeah..."
        ...
        n "Really?"
        n "Well..."
        n "I mean, Sam's pretty weird, so I wouldn't doubt that she has some weird hobbies..."
        n "...Not that there's anything wrong with that!"
        n "Uu..."
        n "It's not like...I would judge her or anything..."
        "Bladewolf has trouble finding words."
        n "I-I guess I should try not to be so mean to her..."
        n "If she feels insecure about her weird behaviors and stuff..."
        n "I mean, I always hate people who make me feel insecure..."
        n "And Sam made me feel insecure yesterday!"
        n "But the way you put it, it sounds like she's learned her lesson..."
    ...
    if n_appeal >= 2:
        ...
        n "It's what I do best, after all!"
...
label ch3_n_end:
    ...
    n "Besides...the beach is awesome!"
    n "Kinda hard to write anything negative about the beach."
    if not y_read3 or y_appeal >= 3:
        ...
        n "I mean, after Sam and I realized we kind of wrote about the same thing..."
        n "She wanted to pick a topic and have us both write about it, or whatever."
        if y_readpoem:
            if not y_read3:
                mc "I see..."
                "I don't really have much to contribute here, since I didn't actually read Sam's poem..."
            else:
                mc "I see..."
                "Something tells me the poem Sam showed me isn't the one she plans on sharing with everyone else..."
                "Of course, I choose not to mention that to Bladewolf."
    else:
        mc "Well, Sam's take on it was a little more solemn."
        n "Well, that's--"
        n "Jeez...she better not have said anything bad about mine!"
        n "After all, she was the one who wanted us to write about the same topic."
    n "Ugh...you can really see her doing that, too."
    n "Making us write about a simple topic, then trying to impress me by coming up with something all fancy."
    n "Well, it's not like I care."
    n "I just did it anyway."
    n "I mean, I guess mine ended up being kind of metaphorical too..."
...
label ch3_n_end_special:
    ...
    if y_read3:
        "This clearly isn't the poem that Sam told me she had written..."
        "...Meaning I'm probably the only one she's showing this to."
    ...
    n "Expressing things that you can't just say..."
    mc "Yeah...I understand."
    ...
    n "Well...yeah..."
    n "I'm...I'm a pro, so..."
    "Bladewolf mumbles, completely failing to sound confident like she usually does."
    n "Just..."
    n "Remember that...I can think these things sometimes, too!"
    n "You know, when you're nice to me, it's..."
    n "..."
    n "...Meaningful."
    mc "Ah...I'm glad."
    "Sensing Bladewolf is satisfied, I start to hand the poem back to her."
    "But as I do so, Bladewolf takes my hands and pushes them back away."
    ...
    n "I just don't!"
    n "Jeez..."
    "I realize what Bladewolf is doing."
    ...
    n "..."
    n "Never mind..."
    n "Just...I'm glad that you want it."
    "Bladewolf backpedals on her words and leaves it at that."
    "Despite her best efforts to hide her expression, I can see her faintly smiling to herself."
    n "That's all for now, so..."
    n "Go put it away before someone sees it, okay?"
    mc "Ah...yeah."
    mc "I'll go do that."
    "With that, I return to my seat so that I can put away Bladewolf's poem."
    return
...
label ch1_s_end:
    ...
    s "Armstrong's the best!"
    mc "Ah...yeah."
    s "But next time, I won't forget."
    s "And I'm gonna write the best poem ever!"
...
label ch2_s_end:
    ...
    mc "Holy crap..."
    mc "raiden, did you really write this?"
    s "Of course I did!"
    ...
    s "Armstrong taught me a whole lot!"
    ...
    "raiden's always had a habit of getting obsessed with something, before dropping it no more than a week later."
...
label ch1_m_end2:
    ...
    m "Ahaha. It's okay."
    m "Yeah, that kind of style has gotten pretty popular nowadays."
    m "That is, a lot of poems have been putting emphasis on the timing between words and lines."
    m "When performed out loud, it can be really powerful."
    mc "What was the inspiration behind this one?"
    m "Ah..."
    m "Well, I'm not sure if I know how to put it..."
    m "I guess you could say that I had some kind of epiphany recently."
...
label ch2_m_end:
    ...
    m "I kind of like playing with my space on the paper..."
    ...
    m "Ahaha."
    m "Sometimes asking what a poem is about isn't the right question."
    ...
    m "Wait...is this tip even about writing?"
...
label ch3_m_end:
    ...
    m "But it was kind of on my mind, so that's what I wrote about."
    mc "I see..."
    mc "I never really put much thought into it."
    m "In a way, it's almost paradoxical."
...
label ch1_n_bad:
    ...
    n "[player], if you're not going to take this club seriously then go home."
    mc "W-What??"
    mc "Harsh..."
    n "What, you expect me to believe that you actually put effort into this?"
...
label ch1_n_med:
    n "..."
    mc "...?"
    n "...Well, it's about what I expected from someone like you."
    ...
    n "Do you want to get smacked?"
    mc "I'll pass..."
    n "Sigh..."
    n "Well anyway, I guess I need to show you mine."
    n "Not that you'll like it."
    return

label ch1_n_good:
    n "..."
    mc "...?"
    n "...Okay, well let's start with the things I don't like!"
    n "First of all, um..."
    mc "..."
    "Bladewolf re-reads my poem."
    n "N-Never mind. I don't feel like giving you my opinion."
    ...
    mc "Like Armstrong said."
    n "Uuuu...!"
    n "Well I would be more comfortable sharing my poem if yours was really bad!"
    n "You were supposed to show me some dumb poem and make me go 'Hah, well it's not that great but let me show you what real literature looks like!'"
    n "And you went and ruined it!"
    n "I hope you're happy!"
    mc "..."
    mc "...So, in other words, you're saying you liked it?"
    n "Urk--"
    "Bladewolf's retort gets caught in her throat."
    n "Uuuuuuuuu...You're so...!"
...
label ch2_n_bad:
    ...
    if n_poemappeal[0] < 0:
        ...
        mc "That's good..."
        n "But I still don't like this at all."
        n "It's trying too hard to be serious."
        mc "Eh? What do you mean by that?"


        label ch2_n_bad_sharedwithch3:
            n "Poems don't need to be all deep-sounding to express something."
            n "It's going to just sound like you're forcing it unless you really don't suck at it."
            n "Honestly... Don't bother trying to write poems like this until you're on Sam's level--"
            show bladewolf             "Bladewolf stops short all of a sudden."
            n "D-Don't...tell me..."
            mc "Eh?"
            n "You're not...you're not just trying to impress Sam, are you?!"
            mc "W-What are you talking about?? And keep your voice down...!"
            n "You know Sam would love this kind of...this angsty.......!!"
            ...
            n "I am so done with you."
            "Bladewolf shoves the poem I handed her back over to me."
            n "Take your stupid poem. If you wrote it for someone else, just don't show it to me!"
            mc "Ouch..."
            ...
            "At least Bladewolf wasn't really the girl I was trying to impress in the first place..."
            $ skip_poem = True
            return
    else:
        ...
        n "I mean, I always like poems that aren't trying too hard."
        n "I hate when people try to sound fancy or add more meaning just by using annoying and complicated language."
        n "Just make it simple, cute, and to the point!"
        n "Sam's head over heels for all this cryptic nonsense, but I see right through that BS. Hah!"
        n "Making your reader look so hard for all this deep meaning is just an excuse to have no meaning at all."
        mc "I guess that's one way to look at it."
        n "Well, everyone has their own opinion."
        n "But my opinion is the best opinion. I'm sure you've figured that out already."
        mc "Er..."
        n "Anyway, here's my poem. Maybe you'll learn something."
        return
...
label ch2_n_med:
    ...
    if n_poemappeal[0] < 0:
        ...
        label ch2_n_med_shared:
            n "Come to think of it, this kind of reminds me of raiden's poem from yesterday..."
            mc "Eh? You think so?"
            n "Yeah. Well I guess if you've been friends with her for so long, you might be on the same wavelength."
            n "But you never really struck me as her type."
            mc "raiden has a 'type' all of a sudden...?"
            n "Well, I don't know! But honestly, how can someone so...er, fluffy...spend so much time with someone like you?"
            ...
            n "Whatever it is, I don't get it..."
...
label ch2_n_good:
    ...
    if n_poemappeal[0] != 1:
        n "..."
        "Bladewolf reads my poem."
        "She keeps glancing at me, then back at the poem."
        "By now, she must have read it more than once."
        n "...Aren't you supposed to be bad at this?"
        mc "...Is that a compliment?"
        n "N-No! I mean... You know..."
        "Bladewolf struggles to find the words she wants."
        n "I just...expected a lot less after what you showed me yesterday."
        n "That's all."
        ...
        n "I mean well-written! No, I mean--"
        mc "Ah, so that's how it is. My poem is cute?"
        n "No! Why are you smiling?! It's not like I like cute things!"
        "Bladewolf shoves my poem back towards me."
        n "H-Huh! Reading it again, I decided that it's not so great after all."
        n "It's too cute and doki-doki."
        n "It would only impress...you know, girls...who like those kinds of things."
        n "Ahaha!"
        "For some reason, Bladewolf is incredibly easy to see through."
        n "Well, anyway...!"
        n "You're gonna read mine now, right?"
        n "Judging by your tastes, you'll probably like it a lot."
        n "You'll probably learn something, too. Don't forget who the {i}real{/i} pro is."
        return
    else:
        ...
        label ch2_n_good_sharedwithch3:
            ...
            n "Obviously! You think I'd let you enjoy Sam's writing more than mine?"
            n "Give me a break."
            mc "Well..."
            mc "In that case, what's the problem with me trying to impress you?"
            n "I'll tell you! You--"
            n "--"
            "Bladewolf's face freezes, like she just realized something."
            n "Y-Y-You..."
            n "You're trying to...impress {i}me?{/i}"
            show bladewolf             "Bladewolf vigorously scans her eyes over my poem one more time."
            "Then, the poem slips out of her hands and flutters to the floor."
            n "I...have to use the bathroom!"
            show bladewolf at lhide
            hide bladewolf
            "Red-faced, Bladewolf quickly walks out of the room."
            show armstrong zorder 2 at t11
            m "Hey, [player]..."
            m "Did you do something to Bladewolf?"
            ...
            "There's no way I could tell Armstrong that I'm trying to impress Bladewolf."
            m "Hmm?"
            "Armstrong sees the poem lying on the floor and swiftly picks it up."
            if m_readpoem:
                "She skims over it a second time, her smile not fading from her face."
                m "I see."
                m "At first I just thought you liked her writing style..."
                m "But you wrote this {i}for{/i} Bladewolf, didn't you?"
            else:
                $ n_poemearly = True
                "She reads through it, her smile not fading from her face."
                m "I see."
                m "You wrote this for Bladewolf, didn't you?"
            mc "I-I mean..."
            mc "Not really..."
            m "In fact, didn't she like your poem a lot the other day, too?"
            m "I'm surprised you know her taste so well already."
            m "Are you sure you're not cheating, [player]?"
            mc "Cheating...?"
            mc "What do you mean by that?"
            m "Never mind, I'm just kidding. Ahaha!"
            "I didn't understand Armstrong's joke at all."
            m "Anyway..."
            m "How do you think Bladewolf feels about you?"
            m "Oh, you don't need to answer that."
            m "It was just something for you to think about."
            show armstrong zorder 2 at t22
            show bladewolf at l21
            n "Hey!"
            "Bladewolf comes up and snatches the poem out of Armstrong's hands."
            "Neither of us had noticed her reenter the classroom."
            show bladewolf zorder 3 at f21
            n "Did you read this, Armstrong?"
            ...
            n "Okay, well, I think [player] is done sharing this poem with everyone."
            n "It's not like anyone would want to read this anyway."
            n "In fact, I'm just going to hold onto this."
            show bladewolf zorder 2 at t21
            show armstrong zorder 3 at f22
            m 5 "If you insist~"
            show armstrong zorder 2 at t22
            ...
            if s_readpoem and y_readpoem:
                "Well, I guess Bladewolf has my poem now."
...
label ch3_n_bad:
    ...
    if n_poemappeal[0] < 0 and n_poemappeal[1] < 0:
        ...
        n "As long as you're not just trying to impress Sam or something like that."
        n "Gross."
        mc "Okay, okay."
        mc "Like you said, I'm allowed to try new things."
        label ch3_n_shared:
            show bladewolf             mc "Why are you so emotionally invested in my poems, anyway?"
            mc "Isn't that more of a compliment to me?"
            n "...Eh?"
            n "N-No! Gross!"
            n "It's not like I care!"
            ...
            show bladewolf             mc "{i}Guh--!!{/i}"
            "Bladewolf's elbow connects with my stomach."
            n "Oh?"
            ...
            "I should really just watch my mouth around Bladewolf."
            n "Anyway..."
            "Bladewolf holds her poem out to me like nothing even happened."
            return
...
label ch3_n_good:
    ...
    if n_poemappeal[0] < 0 and n_poemappeal[1] < 0:
        ...
        n "Well... Well, of course!"
        n "I just had to put you in your place a little bit!"
        n "It's not like..."
        ...
        n "That's such a dumb thing to get jealous about."
        n "Ahaha!"
        mc "Bladewolf..."
        n "What??"
        ...
        n "My writing is obviously the best..."
        n "...Right?"
        mc "..."
        "It took me a while to figure out, but I think I finally did."
        "Maybe Bladewolf acts so arrogant because she's trying to make up for her own insecurities."
        "If she acts like she's the best, then other people might think that way, too."
        n "Right...?"
        n "[player]..."
        n "Please just tell me you like my poems."
        n "I don't care if you hate them."
        n "Just please tell me I'm the best."
        n "I just..."
        n "I just really need to hear that from someone."
        n "I know I sound stupid."
        n "But there's a reason I never shared my poems before this."
        mc "Bladewolf..."
        n "Because..."
        n "Because nobody ever takes me seriously!"
        n "What's the point in sharing my poems if people just laugh and say \"That's so cute, just like you, Bladewolf!\""
        n "Sometimes I don't want to be cute!"
        n "But nobody understands that!"
        n "I try really hard when I write."
        n "The style doesn't matter."
        n "The emotions are there."
        n "Why can't anyone {i}see{/i} that...?"
        n "I just want..."
        "Bladewolf trails off."
        ...
        n "D-Don't read it!"
        "Before I can pick it back up, Bladewolf snatches the poem up from the desk."
        n "It's not any good."
        ...
        mc "I really do."
        show bladewolf         mc "Why would I judge you for your style?"
        ...
        mc "And it's wrong for Sam to think your style is more amateur than hers."
        mc "And raiden... She always means well..."
        ...
        show bladewolf         mc "Ah-- Bladewolf, you're doing it again--"
        "Once again, Bladewolf clutches her poem a little too hard."
...
label ch1_s_bad:
    ...
    s "...Wow!"
    s "[player]..."
    s "Your poem is really bad!"
    s "Ahahaha!"
    mc "Eh?!"
    s "It's fine, it's fine~"
    s "It's your first time."
    s "Besides..."
    label ch1_s_shared:
        s "I'm really happy just that you wrote one."
        ...
        s "That's something that only really good people do!"
        mc "Thanks...raiden."
        "...I'm not sure if raiden sees the full picture of my motive here."
        "Then again..."
        ...
        s "Don't worry, I'm really bad at this."
        s "Ehehe..."
...
label ch1_s_good:
    ...
    mc "Jeez..."
    if y_readpoem:
        "Sam's opinion was way more constructive than this..."
    else:
        "I'm sure Sam's opinion has to be a little more constructive than this."
    if not n_readpoem:
        "Maybe even Bladewolf's."
    ...
    s "It's a [player] poem!"
    s "And that makes it feel extra special!"
    s "Like I can feel your feelings in it~"
    "raiden hugs the sheet against her chest."
    mc "You're so weird, raiden..."
    s "Ehehe..."
    jump ch1_s_shared
...
label ch2_s_bad:
    s "..."
    s "Ehehe, I love reading your poems~"
    s "It's like I never know what I'm going to get!"
    mc "So basically you're saying it sucks."
    s "No! Not at all!"
    s "...Maybe!"
    s "Just a little?"
    s "Sam must have spoiled me a little bit with her poems..."
    s "Ehehe..."
    ...
    label ch2_s_shared:
        ...
        s "Aww, you want to write something for me?"
        s "That's so sweet~"
        mc "Yeah, right."
        ...
        s "Ehh?"
        s "Well..."
        s "I don't really know what you mean, but I'll try to keep it in mind!"
        mc "Well, whatever..."
        s "Anyway, let's see..."
        s "Hmm..."
        s "I guess I like...happy poems~"
        s "Wait, sometimes I like sad poems too..."
        s "Sometimes a little bit of both..."
        s "There's a word for that, right...?"
        s "What's the word I'm looking for..."
        s "...Bittersweet!"
        s "Yeah!"
        s "I like things that are happy and things that are sad."
        mc "Happy and sad?"
        mc "I can't see you liking something sad, raiden..."
        s "Well..."
        s "I like happy the most!"
        s "But sometimes when you have a little raincloud in your head..."
        s "A sad poem can help give the raincloud a little hug..."
        s "...And make a nice happy rainbow!"
        mc "...raiden, that's unexpectedly poetic."
        s "Eh? It is?"
...
label ch2_s_med:
    ...
    if s_poemappeal[0] < 0:
        ...
        label ch2_s_med_shared:
            s "Well, I'm not very good at figuring out if poems are good or bad..."
        ...
        s "You know I wouldn't lie to you, [player]...!"
        s "Never ever!"
        mc "Yeah, I guess so..."
...
label ch2_s_good:
    ...
    if s_poemappeal[0] < 1:
        ...
        mc "Ugh..."
        mc "You're too honest sometimes, raiden."
        s "No, but really!!"
        s "I wanna put this on my wall~"
        s "Can I?"
        mc "raiden..."
        mc "You must be seriously overreacting."
        mc "I'm not a good writer at all."
        ...
        s "Eh?!"
        s "No way!!"
        s "Not even Bladewolf...?"
        mc "Well, I guess Bladewolf is the least likely to admit how much she likes something..."
        ...
        mc "Sigh..."
        mc "You never understand when I try to explain things to you, do you, raiden?"
        "I pat raiden's head."
        s "Ahaha! Heyyy!"
        s "I'm not a kid, you know!"
        mc "Are you sure about that?"
        s "Mmmm, maybe~"
        "raiden starts fiddling with her pencil between her hands."
        s "Hey, [player]..."
        s "Will you give me your poem?"
        ...
        s "Ehehe..."
        mc "!!"
        mc "raiden, you completely misunderstood!"
        ...
        s "A-Ah!!"
        s "I broke my pencil..."
        "raiden hastily bends down to pick up the piece she dropped."
        ...
        "raiden clutches the desk beside her to support herself, knees shaking."
        s "I-I'm a little clumsy today..."
        s "Ahahaha..."
        mc "Let's sit down, raiden..."
        s "Y-Yeah..."
        "I grab raiden's arm and help her sit at the desk."
        mc "Anyway, I still haven't read your poem..."
        s "Oh!"
        s "Sorry, I forgot about that~"
        s "But it's not as good as yours!!"
        mc "Jeez, don't worry."
...
label ch3_s_bad:
    ...
    s "After all, you wrote this for someone else, didn't you?"
    s "Probably [currentname]..."
    mc "Eh??"
    mc "I didn't write this for anyone specifically!"
    s "Maybe..."
    s "That's not really what I meant, though."
    s "But it's okay."
    s "You're making new friends, just like I was hoping."
    s "That makes me...really happy."
    ...
    mc "raiden...?"
    s "Tell Armstrong I wasn't feeling well, okay?"
    s "I'll see you tomorrow~"
    "Before I can say anything else, raiden cheerfully walks out of the classroom, humming to herself."
    $ skip_poem = True
    return
...
label ch3_s_good:
    if poemwinner[0] != "raiden" and poemwinner[1] != "raiden":
        jump ch3_s_bad
    s "..."
    ...
    s "Mhm~"
    mc "..."
    mc "raiden, you've been a little quiet today."
    ...
    s "No, that's silly!"
    s "Don't worry about me, okay?"
    s "I only want to see smiles on your face~"
    mc "Well, alright..."
    s "Hey, [player]..."
    s "I'm still a little surprised."
    s "I really thought that you would try writing your poems like the way Sam does..."
    s "Or even Bladewolf..."
    s "But in the end..."
    mc "...Yeah."
    ...
    mc "I still understand you the most, raiden."
    ...
    "raiden has trouble keeping her voice steady, all of a sudden."
...
label ch1_y_bad:
    ...
    y "Hold on..."
    y "...Okay."
    y "This is your first time writing a poem, right?"
    mc "Er, yeah..."
    mc "Why do you ask?"
    ...
    "It might take Sam a while to get used to new people..."
    mc "It's fine, I really didn't notice."
    mc "What were you saying?"
    y "Right...um..."
    label ch1_y_shared:
        y "It's just that there are specific writing habits that are usually typical of new writers."
        y "And having been through that myself, I kind of learned to pick up on them."
        y "I think the most noticeable thing I recognize in new writers is that they try to make their style very deliberate."
        y "In other words, they tend to pick a writing style separate from the topic matter, and they form-fit the two together."
        y "The end result is that both the style and the expressiveness are weakened."
        "Once Sam finds her train of thought, it's as if her demeanor totally changes."
        "Her stammering is completely gone, and she sounds like an expert."
        y "Of course, that's not something you can be blamed for."
        y "There are so many different skills and techniques that go into writing even a simple poem."
        y "Not just finding them and building them, but getting them to work together is probably the most challenging part."
        ...
        y "Bladewolf can be a little bit biased, though..."
        mc "Biased? How?"
        y "U-Um..."
        y "Well..."
        y "Never mind..."
        ...
        y "Sorry..."
        mc "It's fine."
        "I'm not sure if Sam is apologizing to herself, to me, or to Bladewolf."
        mc "Do you mind if I read your poem now?"
        y "Please do!"
        y "I'd love to share my thought process behind it..."
        "Sam smiles dreamily, as if that's a rare opportunity for her."
...
label ch1_y_good:
    y "..."
    "As Sam reads the poem, I notice her eyes lighten."
    y "...Exceptional."
    mc "Eh? What was that?"
    y "...?"
    y "D-Did I say that out loud...?"
    "Sam first covers her mouth, but then ends up covering her whole face."
    y "I...!"
    y "Uu..."
    y "{i}(He's going to hate me...){/i}"
    mc "Um..."
    mc "You really didn't do anything wrong, Sam..."
    y "Eh...?"
    y "That's..."
    ...
    "Sam takes a breath."
    y "So..."
    y "What kind of writing experience do you have?"
    ...
    y "Huh...?"
    "Sam stares at me blankly, then looks at my poem again."
    y "..."
    y "...Well, I know that!"
    y "I just meant...u-um..."
    "Sam trails off, unable to find an excuse."
...
label ch2_y_bad:
    ...
    if y_poemappeal[0] < 0:
        ...
        mc "Eh?!"
        y "For disrespecting Bladewolf yesterday..."
        ...
        y "I know this is what Armstrong wants."
        y "But it's not fair to you when you could be enjoying your time with Bladewolf and raiden."
        mc "Sam--"
        y "Please..."
        ...
        y "That's...all I need."
        mc "..."
        "Sam smiles sadly and puts her head down on her desk."
        "I'm frustrated."
        ...
        y "I respect you for trying different things, [player]."
        y "Were you inspired by Bladewolf's poem?"
        y "Or raiden's, perhaps?"
        mc "Well..."
        ...
        label ch2_y_shared:
            ...
            "Sam nods, and timidly hands me her poem."
            return
...
label ch2_y_med:
    ...
    if y_poemappeal[0] <= 0:
        ...
        mc "I guess you could say that..."
        y "I was also a bit surprised by how differently everyone writes."
...
label ch2_y_good:
    ...
    if y_poemappeal[0] < 1:
        ...
        label ch2_y_good_shared:
            ...
            show sam at t11
            "Sam breathes and collects her thoughts."
            "I know that Sam likes to think before she speaks, so I offer that patience to her."
            y "Yeah..."
            ...
            y "And besides..."
            y "...People would just laugh at me!"
...
label ch3_y_bad:
    if y_poemappeal[0] < 0 and y_poemappeal[1] < 0:
        label ch3_y_bad12_shared:
            y "..."
            "Sam doesn't look too enthusiastic about spending time with me..."
        ...
        y "I probably just sounded arrogant!"
        y "I'm so stupid..."
        mc "Sam, that's a little--"
        y "No..."
        y "You don't understand."
        y "I spent so much time worrying about what's better and what's worse."
        y "Not just with you..."
        y "With Bladewolf, and raiden..."
        y "It's obvious now why nobody has fun when talking to me..."
        y "And because of that..."
        y "...I'll just keep my mouth shut about your poem!"
        mc "..."
        "Sam buries her head into her arms on her desk."
        ...
        y "Being disliked."
        mc "Sam..."
        y "What...what am I saying?"
        y "I'm sorry..."
        y "I never meant to bring this up..."
        "Sam turns away from me."
        y "You should go..."
        mc "Eh...?"
        y "Please..."
        ...
        label ch3_y_shared:
            y "As always, I believe what's most important is exploring and discovering yourself."
            ...
            y "Is that so...?"
            y "..."
            "Sam thinks for a good minute."
            y "...That must be terrible."
            mc "Eh?"
...
label ch3_y_med:
    if y_poemappeal[0] < 0 and y_poemappeal[1] < 0:
        ...
        y "It's a lot more fun and rewarding than I anticipated."
        y "I need to remember to thank Armstrong..."
        y "I think we all felt a little awkward at first."
        y "But now it seems like everyone is enjoying sharing their writing and seeing what others think."
        ...
        mc "Eh?"
        y "Well, you know how I like to say that writing is a very personal way to get in touch with yourself..."
        y "In the end, it doesn't matter if you're a good writer, or a bad writer."
...
label ch3_y_good:
    ...
    if y_poemappeal[1] < 1:
        ...
        label ch3_y_good_shared:
            ...
            y "Cheerful people, who always put a smile on your face..."
            ...
            y "...You know?"
            y "And those friends don't laugh at me..."
            y "They don't tease me for spacing out all the time..."
            y "They don't make fun of my body type..."
            y "And..."
            y "...And they don't hate me for acting like a know-it-all!"
            ...
            y "That I started sharing it with you..."
            ...
            y "That's really...important to me."
            ...
            y "...I just feel really happy."
            mc "I see..."
            mc "Well, I treat you how you deserve to be treated, Sam."
            ...
            y "...Yeah..."
            y "We really are friends now, aren't we?"
            "Sam puts her head in her hands."
        ...
        y "I-Is that so...?"
        "Sam gently smiles to herself."
        y "This feeling..."
        y "I'm so glad...I got the chance to share my writing."
        y "I never thought it would feel like this."
...
label ch1_m_start:
    ...
    m "Everyone else might be a little bit biased toward their own kinds of styles..."
    m "But I'll always help you find what suits you the most!"
...
label ch2_m_start:
    ...
    if n_poemearly:
        $ n_poemearly = False
        m "That was kind of silly with Bladewolf earlier, wasn't it?"
        m "I'm glad the two of you have been getting along so well."
        mc "..."
        "That's one way of putting it..."
        m "Anyway, I already read your poem, but you can go ahead and read mine now."
...
label ch3_m_start:
    ...
    if n_poemearly:
        ...
        m "Anyway, let's take a look at today's poem!"
        mc "Sure..."
        "I let Armstrong take the poem I'm holding in my hands."
        m "..."
...
label m_natsuki_1:
    ...
    mc "If you say so."
    m "Yep!"
    m "By any chance have you read anything by Shel Silverstein?"
    mc "Eh?"
    ...
    m "And sometimes they're only a few lines long."
    ...
    mc "I see..."
    mc "So you're saying that Bladewolf is kind of like that?"
    m "Sort of."
    ...
    m "So I can see why it would be your kind of poem to explore!"
    return

label m_sayori_1:
    m "I like this one!"
    m "It makes me think of something Raiden would like."
    mc "Is that so?"
    m "You and raiden are really good friends, right?"
    m "I wouldn't be surprised if you had those sorts of things in common."
    mc "Ah, well..."
    mc "We may be good friends, but Raiden and I are actually really different."
    m "Hmm..."
    m "Well, that may be the case."
    m "But maybe there are also some similarities that you wouldn't expect."
    ...
    m "So I think that's the kind of vibe I get when reading your poem."
    mc "Hmm..."
    mc "You sure you're not reading into it too much?"
    m 5 "Ahaha! I could be!"
    m "Oh gosh, I sound like Sam..."
    m "...But in any case, Raiden's writing has kind of a gentle feel to it."
    ...
    m "Well, to each their own~"
    m "And you shouldn't be afraid to experiment a little bit, either."
    return
...
label m_yuri_1:
    ...
    m "Unlike raiden, who likes using simple and direct words to describe happiness and sadness..."
    m "Sam likes it when readers are left to derive their own meaning out of it."
    m "It's very challenging to write like that effectively."
    m "Both allowing people to get something out of it just by feel..."
    m "Or letting them deeply analyze all of the nuances."
    m "It can take years of practice, which I'm assuming Sam has at this point."
    m "I never really asked, though..."
...
label m_natuski_2:
    m "It's pretty good~"
    m "You've been spending some time with Bladewolf, haven't you?"
    m "You must like her writing style."
    mc "Ah, yeah..."
    mc "I think it's a neat way to tell a story."
    m "Mhm. I don't disagree."
    m "Bladewolf's poems may be cute, but they're also meaningful."
    m "I can see why you'd be into the style."
    m "I guess that means you're not as much a fan of Sam's poems, then?"
    mc "Ah-- I wouldn't say that..."
    mc "I kind of like everyone's poems."
    m "That's true, but I'm sure you like some more than others, right?"
    m "Like Sam's use of complex words and symbolism..."
    m "Or raiden's way of expressing happiness or sadness in a more direct way."
    m "You must have some kind of preference, don't you?"
    m "Ah, not that it's a contest or anything!"
    m "I was just curious, that's all."
    return

label m_sayori_2:
    m "It's pretty good~"
    m "It makes me think of raiden, like the other one that you wrote."
    m "You two are like the dynamic duo!"
    mc "Ahaha... That's kind of exaggerating it."
    m "Yeah, probably."
    m "But you do spend a lot of time with her even in this club, don't you?"
    m "Then again, I don't blame you for being a little shy~"
    mc "I-I'm not shy, it's just..."
    m 5 "Ahaha! I'm just teasing."
    m "I know it takes a bit of time to make friends with everyone."
    m "But Sam and Bladewolf are super interesting people, so don't be afraid to give them their share of time!"
    m "And you can talk to me every now and then too..."
    m "I'm not, like, unapproachable or anything, am I?"
    mc "Ah, no, it's nothing like that..."
    mc "I'm just still getting used to being here, that's all."
    m "Yeah..."
    m "I'm sorry if I was putting pressure on you or something!"
...
label m_yuri_2:
    ...
    m "Just wondering, but have you been finding inspiration in Sam's writing style?"
    mc "Hmm..."
    mc "I guess so."
    mc "You can't deny that she's talented."
    m "Yeah, totally!"
    m "I think her poems are the most..."
    m "...Romantic."
    m "That's the best way to describe it."
    m "She's like a totally different person when she picks up a pen..."
    ...
    m "But still, defending her like that..."
    m 5 "You must be pretty into her..."
    mc "Eh?!"
    mc "You...completely misunderstood!"
    m "Ahaha! Calm down, I'm kidding!"
    m "Besides, I'm pretty sure she's already got a boyfriend..."
    mc "Wait, really?"
    m "Yeah. A fictional one, anyway."
    "Armstrong kind of whispers that last part to me."
...
label m_natsuki_3:
    m "Sticking with the Bladewolf style once more, I see~"
    m "Hmm..."
    m "You really like Bladewolf, don't you?"
    mc "Eh? That's--"
    ...
    mc "Y-You know how Bladewolf is...!"
    mc "If I don't indulge her, she'll end up hating me."
    m "Eh?"
    m "No, I think you're misunderstanding, [player]."
    m "It's not like Bladewolf just hates anyone who doesn't give her what she wants."
    m "Yeah, she's assertive, but she's not that selfish..."
    ...
    m "...Be careful. Please?"
    m "Bladewolf is kind of unpredictable."
    m "A lot of times, she doesn't even know what she wants."
    m "After all, she's the youngest one here."
    m "She might not know how to handle her own feelings properly."
    m "What I'm saying is..."
    m "If something bad happens, then it could end up damaging the club, too..."
    m 5 "And you wouldn't do that to me...right?"
    mc "That's--"
    "I'm not sure how to respond to Armstrong."
...
label m_sayori_3:
    ...
    mc "How so?"
    m "No, not the poem..."
    m "I mean, it's funny how your poems and raiden's poems have been getting more and more similar to each other every day."
    m "I'm surprised you're so in sync with her."
    m "Then again, you've been spending a lot of time together lately, haven't you?"
    ...
    m "I see, I see~"
    m "That reminds me..."
    m "About how raiden's been a little bit off today..."
    mc "Yeah? Did she tell you something?"
    m "Ah..."
    m "Well..."
    m "[player], you haven't been flirting with her, have you?"
    mc "O-Of course not!"
    ...
    m "raiden's been acting so much happier ever since you joined the club."
...
label m_yuri_3:
    m "Your style's gotten so refined, [player]."
    m "Sam's been teaching you a lot of things, hasn't she?"
    mc "Well--"
    mc "I guess so."
    m "Yeah... I've been noticing how much time you spend with her."
    m "I think I've heard her say more words these past couple days than she's talked in the whole year."
    ...
    m "Alright, alright~"
    m "I get you."
    m "Just...be careful, alright?"
    m "I know that Sam isn't used to opening herself up..."
    m "So if something bad happens while she's vulnerable..."
    m "Then it could be really hard for her."
    m "Her books aren't a total escape from reality."
    m "They're just a bandage."
    mc "You say that like I'm going to hurt her..."
    m "Sorry, I didn't really mean that~"
