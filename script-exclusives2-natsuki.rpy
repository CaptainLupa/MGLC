...
label bladewolf_exclusive2_1:
    ...
    n "fucking armstrongmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm"
    $ style.say_dialogue = style.normal
    $ _history_list[-1].what = "Freaking Armstrong..."
    ...
    n "Consider this a lesson straight from the Literature Club:{nw}"
    ...
    show n_cg1_exp3 at cgfade
    n "'Cept Armstrong's kind of a jerk about it..."
    ...
    "Bladewolf is strangely quiet now."
    ...
    n "Y-Yeah...?"
    "Suddenly, Bladewolf collapses straight into me."
    play sound fall
    $ style.say_dialogue = style.normal
    mc "H-Hey--"
    show n_cg1_exp5
    ...
    m "Here..."
    show armstrong zorder 2 at t21
    "Armstrong reaches into her bag and pulls out some kind of protein bar."
    "She throws it in Bladewolf's direction."
    "Bladewolf's eyes suddenly light up again."
