label ch4_main:
    ...
    if ch4_scene == "bladewolf":
        "I've been getting increasingly anxious about Bladewolf's upcoming visit."
        ...
        "But putting Bladewolf aside..."
    else:
        "I've been getting increasingly anxious about Sam's upcoming visit."
        "I keep telling myself there's no reason to be nervous, but it doesn't help much."
        "Sam is clearly an introvert and also an intimate person in general."
        ...
        "But putting Sam aside..."
    "I haven't heard a thing from raiden since she left club early the other day."
    "It's not like we text each other all the time or anything..."
    "But I've been worried about her in the back of my mind."
    "Between what raiden said, and what Armstrong said..."
    "Is it really okay for me to put raiden's feelings aside when she might need me?"

    stop music fadeout 2.0
    scene bg house
    with wipeleft_scene
    "I decide to visit raiden before [ch4_name] comes over."
    "Rather than asking, I simply tell her \"I'm coming over\", much like we've done in the past."
    "Once I reach raiden's house, I knock on the door before entering it myself."
    ...
    "The house is quiet."
    "raiden isn't anywhere on the first floor, so I assume she's up in her room."
    ...
    s "Hi [player]~"
    show raiden     "I sit down in her room."
    "raiden forces a smile, but it's easy to tell that she's different."
    ...
    "raiden's room is as messy as it's always been."
    ...
    "raiden had already left by the time we decided that last meeting."
    s "Armstrong told me."
    s "It's only natural for her to keep me informed about the festival preparations, right?"
    mc "Ah, that's true..."
    mc "But what about you?"
    mc "Aren't you going to be helping Armstrong today?"
    s "Of course!"
    ...
    show raiden     "raiden stares in a random direction."
    ...
    mc "So..."
    "raiden smiles, shaking her head."
    s "That's no good, [player]."
    mc "Eh?"
    ...
    s "Ehehe~"
    mc "raiden!"
    show raiden     "I grab raiden by the shoulders."
    ...
    s "Ah..."
    s "Ahaha..."
    "raiden gives me an empty smile."
    s "You really put me in a trap, [player]."
    s "But..."
    s "You're wrong."
    ...
    mc "Seeing what?"
    mc "What are you talking about, raiden?"
    s "Ehehe~"
    s "You're really just going to make me say it, aren't you, [player]?"
    ...
    "How is it possible that raiden kept this from me the entire time that I've known her?"
    ...
    s "You don't understand at all, [player]."
    ...
    mc "I don't understand your feelings at all, raiden."
    ...
    "Tears streak down raiden's face."
    ...
    "Without thinking, I once again grab raiden's shoulders."
    ...
    s "[player]..."
    "raiden isn't hugging me back."
    "Despite my arms being wrapped around her, raiden's arms remain at her sides."
    ...
    s "[player]..."
    s "I..."
    "raiden barely manages to speak between her sobs."
    ...
    s "I don't know..."
    s "I don't know."
    "Gently, raiden finally puts her arms around me in return."
    ...
    mc "It would be fun."
    "To my surprise, raiden shakes her head."
    s "I'm sorry."
    ...
    "I say goodbye to raiden and exit her house."
...
label ch4_exclusive_bladewolf:
    play music t6 fadeout 2.0
    scene bg house with wipeleft_scene
    "I spend only a few minutes back at home anxiously awaiting Bladewolf's arrival."
    ...
    n "'Sup?"
    mc "...Hey."
    "I don't know what I was expecting, but seeing Bladewolf in something other than her school uniform totally threw me off."
    ...
    "Bladewolf is carrying a large bag that is probably full of baking supplies."
    ...
    mc "Yeah, I did."
    "Yesterday, Bladewolf asked me to buy a bunch of ingredients if I didn't already have them at home."
    n "Good!"
    n "Glad I could count on you to do your part."
    mc "Well...of course."
    "I'm surprised to hear Bladewolf suddenly say that, rather than something snarky like she usually does."
    ...
    "I grab the bag Bladewolf holds out to me."
    mc "Ghk--"
    ...
    n "And just because I don't have a mature and sexy figure like Sam doesn't mean you should treat me like--"
    n "A-Ah--"
    "Bladewolf catches her words, and her face turns red."
    mc "Bladewolf..."
    n "Forget it!"
    ...
    n "I finally found your weakness, [player]."
    "Bladewolf smiles deviously."
    mc "Please spare me..."
    "Well, if Bladewolf decides to dish out more insults like that, there's no way I'm not fighting back."
    ...
    "Meanwhile, Bladewolf is babysitting all of my movements to make sure I don't mess up her precious baking."
    show bladewolf zorder 2 at t11
    ...
    mc "I'm having fun..."
    "I'm not really sure what Bladewolf is trying to get out of me."
    ...
    "I recall Bladewolf proudly presenting her cat-shaped cupcakes, and raiden and Armstrong's delighted expressions."
    "I wonder if I can make Bladewolf proud like that, too."
    mc "Yeah..."
    ...
    n "Here, look."
    "Bladewolf grabs the whisk from me and uses her other hand to tilt the bowl back."
    n "You really need to...beat...the crap out of it!"
    "After a few seconds, the consistency of the icing has already improved."
    n "See?"
    "As if to emphasize, Bladewolf sticks a finger in the icing and pops it in her mouth."
    "I reluctantly start to do the same."
    n "Hey!"
    "Bladewolf suddenly grabs my wrist."
    ...
    "I triumphantly scoop some with my finger just as Bladewolf tugs with all her might."
    mc "Ah--!"
    "The force of Bladewolf pulling me causes me to stumble, making her stumble in turn."
    n "Gross!"
    n "You got it on my face!"
    mc "Whose fault is that?!"
    "There's a big glob of icing on Bladewolf's cheek."
    n "Nnn--"
    "She tries to reach it with her tongue, but it's too far away."
    n "Jeez..."
    n "You know what?"
    n "Take this!"
    "Bladewolf instead wipes it off with her finger before shoving her finger toward my own face."
    mc "You wish--!"
    "I'm faster."
    "I grab her wrist with my hand before it reaches my face."
    "Bladewolf tries to use her other hand to fight back, but I grab that one as well."
    ...
    hide n_cg3_cake
    "I take Bladewolf's finger and put it in my mouth, licking off the icing."
    ...
    n "A-Ah--"
    "Bladewolf is so surprised that she can't even figure out how to get mad at me."
    ...
    mc "I..."
    "Bladewolf gazes at me in silence."
    ...
    "Bladewolf rushes over to the oven."
    ...
    n "Jeez..."
    "Bladewolf uses an oven mitt to grab the blackened tray out of the oven."
    ...
    "I watch as Bladewolf slides the cupcake trays into the oven."
    ...
    "As soon as Bladewolf opens the oven door, a blast of sweet-smelling warm air fills the room."
    ...
    "Bladewolf hands me some plastic bags."
    ...
    n "W-Well..."
    "Bladewolf's voice trails off."
    n "Same with you..."
    mc "Eh?"
    mc "Did you say something?"
    n "N-No, nothing!"
    n "Let's just do the icing!"
    "Bladewolf picks up the pace and fastens a nozzle onto each of the bags."
    n "There's a lot to do, so we shouldn't be wasting time!"
    n "Here, I'll show you how to do it."
    "Without giving me a chance to think about before, Bladewolf quickly moves on."
    "She shows me how to apply the icing, and then we each get to work."

    scene bg kitchen with wipeleft_scene
    "When we're finally finished, Bladewolf puts them all side by side to admire our work."
    show bladewolf zorder 2 at t11
    ...
    mc "Ahaha."
    mc "raiden's the exact opposite in that regard."
    ...
    mc "Man..."
    "As usual, Bladewolf places the blame on me."
    n "You can bring the cupcakes tomorrow, right?"
    n "If you and raiden each carry some, then you can probably do it in one trip."
    ...
    hide bladewolf
    "I again think back to the conversation I had with raiden earlier today."
    "I felt so helpless."
    "raiden always does listen to me, but at that point it felt like she couldn't listen to me at all."
    show bladewolf zorder 2 at t11
    ...
    scene bg house with wipeleft_scene
    "Just like that, Bladewolf is already about to leave."
    ...
    "Bladewolf looks at me tensely, like she's trying to hide her expression."
    mc "Yeah."
    ...
    stop music fadeout 2.0
    show bladewolf at face with dissolve
    "Bladewolf suddenly gets closer to me."
    mc "Wait, Bladewolf--"
    "Standing inches from me, Bladewolf looks up at me."
    ...
    hide bladewolf
    "Clearly flustered, Bladewolf hurries off, and raiden waves goodbye."
    return

label ch4_exclusive_sam:
    play music t6 fadeout 2.0
    scene bg house with wipeleft_scene
    ...
    show sam     mc "Wait, don't look in there--!"
    "I snatch Sam's wrist, which was in the process of opening a desk drawer of mine."
    y "A-Ah..."
    y "I'm sorry...!"
    y "I wasn't thinking for some reason..."
    y "I was just spacing out!"
    mc "It's fine, it's fine..."
    "I let go of Sam's wrist."
    show sam     "She puts both of her hands firmly in her lap, as if making sure she's keeping track of them."
    mc "So, um..."
    ...
    show sam     "Sam takes the cylinder and pushes a switch on the bottom."
    ...
    show sam     "Sam smiles gently, clearly enjoying herself."
    "She again reaches into her bag and pulls out several spools of thin ribbon."
    show sam     mc "What are those for?"
    y "Well..."
    ...
    mc "I had no idea you'd be so good at this, Sam."
    y "Is...that so?"
    y "Well, I suppose I do get a little intense...as you'd put it."
    y "Uhuhu."
    "Sam giggles with red cheeks."
    ...
    "Sam unravels a long strand of red ribbon to her desired length."
    ...
    y "A-Ah..."
    y "Well..."
    "Embarrassed, Sam looks away."
    mc "What is it?"
    y "You're going to think it's weird..."
    mc "Sam, whatever it is, I have no reason to judge."
    ...
    y "It is, isn't it...?"
    "Sam relaxes her expression once again."
    y "Would you like to hold it?"
    mc "Sure, I'll check it out."
    "Sam carefully hands me the knife, with the handle facing me."
    ...
    "Sam takes my hand and gives the wound a closer look."
    y "Ah..."
    "She stares at it and noticeably fidgets."
    mc "If you're squeamish, I'll go wash it off now--"
    mc "A-Ah!"
    "Without warning, Sam puts my finger in her mouth and licks the wound."
    ...
    y "I wasn't thinking!"
    y "I..."
    "Sam lowers her head, her face burning up."
    mc "Sam..."
    ...
    mc "Sam, I think you're overreacting a little..."
    y "Uuuh..."
    ...
    "I take Sam's hand and lick her index finger in return."
    show sam at h11
    y "[player]--!!"
    y "D-Did you really just do that?"
    mc "N-Now we're even..."
    y "..."
    "Sam just looks at me like I did something wrong."
    mc "Ahaha..."
    ...
    y "You're so weird, [player]."
    "Sam giggles shyly."
    mc "Eh...?"
    "Sam calling {i}me{/i} weird?"
    ...
    "I watch Sam's knife cut through the ribbon like it's nothing but air."
    ...
    mc "It looks great."
    mc "Good thinking coming up with this, Sam."
    show sam zorder 2 at t11
    y "Ah, thanks..."
    ...
    mc "Ah, that's right."
    "One of the items Sam had asked me to buy was a kit of watercolor paint tablets."
    ...
    scene bg bedroom with wipeleft_scene
    "Taking Sam's advice, I decide to use small plastic bathroom cups rather than full-sized glasses."
    "I put them on a plate to catch any paint that drips, then bring it back into my room."
    mc "Sam?"
    show sam zorder 2 at t11
    y "Yes?"
    "I come in to see Sam quickly unrolling her sleeve, pulling it back over her arm."
    mc "Ah, nothing..."
    ...
    "Sam hurriedly dismisses me and takes it upon herself to unwrap the tablets, dropping them into the cups."
    y "So..."
    ...
    hide sam
    "After rolling out the banner, Sam and I kneel on opposite sides so we don't get in the way of each other."
    "Sam uses a brush and adds a few dots of different colors across the banner to serve as a color guide when we paint."
    ...
    "Sam stops painting for a moment, thinking to herself."
    y "For me..."
    ...
    mc "Is that so...?"
    "Even if Sam and I are quite different, I can understand where she's coming from."
    ...
    "Sam leans over the banner to grab an unused paintbrush."
    "But I move at the same time, causing my head to bump into hers."
    y "Kya--!"
    mc "S-Sorry!"
    "Sam reels back, and I quickly lift my hands in surprise."
    mc "Are you hurt?"
    y "N-No, I'm not hurt."
    ...
    mc "Ah, your face..."
    "There are droplets of paint on Sam's face and neck."
    ...
    mc "Here..."
    "I pat down Sam's face and neck with the towel."
    ...
    "But Sam suddenly holds my wrist."
    hide y_cg3_exp1
    y "Wait--"
    mc "Eh?"
    show y_cg3_exp1 at cgfade
    ...
    mc "Ah..."
    "I keep my hand still against Sam's neck."
    hide y_cg3_exp1
    ...
    "Sam's gentle fingers, wrapped around my wrist, send a tingling sensation through my arm."
    ...
    "I hesitantly retrieve my own brush and continue following Sam's example."
    ...
    "Gathering all her things, Sam seems to look a little downcast."
    "I understand why."
    ...
    scene bg house with wipeleft_scene
    "Once Sam packs up, I walk her out the front door."
    show sam zorder 2 at t11
    ...
    mc "Wait--"
    show sam     "I kind of say that without thinking."
    mc "About today..."
    ...
    show sam     "As I stumble over my words, Sam simply smiles bashfully."
    mc "Anyway..."
    mc "You know what I'm trying to say, so..."
    y "You're very thoughtful, [player]."
    "Sam takes a step closer to me, then briefly squeezes my hand."
    show sam at face(y=600) with dissolve
    stop music fadeout 2.0
    y "I kind of like that about you..."
    mc "Well..."
    "How am I supposed to respond to that?"
    "But I don't even get a chance to, as Sam suddenly pulls back."
    show sam zorder 2 at t11
    y "S-raiden--?"
    mc "Eh?!"
    show raiden zorder 3 at f21
    ...
    show sam at lhide
    hide sam
    "Clearly embarrassed, Sam hurries off."
    "raiden waves goodbye after her."
    return
...
label ch4_end:
    ...
    "Tears start to fall down raiden's face."
    s "That's all that matters to me--!"
    ...
    s "Armstrong was right..."
    s "I should just..."
    mc "Armstrong...?"
    mc "Armstrong was right about what?"
    s "..."
    mc "raiden..."
    ...
    s "I'm scared, [player]..."
    s "I'm really scared..."
    mc "What are you scared of, raiden?"
    s "I'm scared that..."
...
label ch4_end_yes:
    ...
    "Suddenly, raiden wraps her arms tightly around me."
    s "[player]..."
    s "Is this...really okay?"
    mc "Yeah."
    "I hold raiden in my arms and pull her closer."
    mc "You'll never have to let go of me again."
    s "I love you, [player]..."
    s "I want to be with you forever."
    mc "Me too."
    s "..."
    "I feel raiden's grip around me weaken a little bit."
    s "What is this...?"
    mc "raiden...?"
    ...
    show raiden zorder 2 at i11
    with dissolve_cg
    "raiden and I slowly release each other."
    mc "So..."
    ...
    s "Hey, [player]..."
    "raiden gazes at me once again, smiling sadly."
    s "Even if I get really, really sad..."
    s "This is the best thing for me...right?"
    mc "Eh...?"
    "I don't really understand what raiden means by that."
    mc "Are you saying that this is making you feel sad, raiden?"
    s "I-I don't know..."
    ...
    hide raiden
    "I say that, but in reality, I've never felt more uncertain when it comes to raiden."
    "I know that I love her, and she loves me."
    "But I'm having as much trouble understanding raiden's feelings as she is."
    ...
    "Is that what raiden meant by not wanting anything to change?"
    "I don't know."
    "But I know that I'll give it everything I've got."
    "raiden is the most important person to me."
...
label ch4_end_no:
    ...
    mc "Armstrong told me the truth..."
    ...
    s "I..."
    s "I...see..."
    "raiden forces a smile through an incredibly pained expression."
    s "Ahaha..."
    ...
    hide raiden
    "raiden looks over her shoulder and flashes me one more weak smile before turning around and running off."
    mc "raiden!"
    "..."
    ...
    "The most I can do is support raiden through her feelings and help her on the path that's right."
    "But I'm having as much trouble understanding raiden's feelings as she is."
    "Even though I can comfort her..."
    "I keep wondering if I should be doing something more, or something different."
    "I know these thoughts will continue to plague me until things are back to the way they were."
    "I'm going to give it everything I've got."
    "raiden will always be my dearest friend."
