default persistent.armstrongtopics = []
default persistent.armstrong_reload = 0
default persistent.tried_skip = None
default persistent.armstrong_kill = None

image mask_child:
    "images/cg/armstrong/child_2.png"
    xtile 2

image mask_mask:
    "images/cg/armstrong/mask.png"
    xtile 3
...
image mask_2:
    "images/cg/armstrong/mask_2.png"
...
image mask_3:
    "images/cg/armstrong/mask_3.png"
    xtile 3 subpixel True
    block:
        xoffset 1280
...
image armstrong_room = "images/cg/armstrong/armstrong_room.png"
image armstrong_room_highlight:
    "images/cg/armstrong/armstrong_room_highlight.png"
    function armstrong_alpha
image armstrong_bg = "images/cg/armstrong/armstrong_bg.png"
image armstrong_bg_highlight:
    "images/cg/armstrong/armstrong_bg_highlight.png"
    function armstrong_alpha
image armstrong_scare = "images/cg/armstrong/armstrong_scare.png"

image armstrong_body_glitch1:
    "images/cg/armstrong/armstrong_glitch1.png"
    0.15
    "images/cg/armstrong/armstrong_glitch2.png"
    0.15
    "images/cg/armstrong/armstrong_glitch1.png"
    0.15
    "images/cg/armstrong/armstrong_glitch2.png"
...
image armstrong_body_glitch2:
    "images/cg/armstrong/armstrong_glitch3.png"
    0.15
    "images/cg/armstrong/armstrong_glitch4.png"
    0.15
    "images/cg/armstrong/armstrong_glitch3.png"
    0.15
    "images/cg/armstrong/armstrong_glitch4.png"
...
image room_glitch = "images/cg/armstrong/armstrong_bg_glitch.png"
...
init python:
    ...
    def slow_nodismiss(event, interact=True, **kwargs):
        if not persistent.armstrong_kill:
            try:
...
label ch30_noskip:
    ...
    m "Thanks~"
    hide screen fake_skip_indicator
    if persistent.current_armstrongtopic != 0:
        m "Now, where was I...?"
        $ pause(4.0)
        if not persistent.current_armstrongtopic or persistent.current_armstrongtopic == 26:
            $ persistent.current_armstrongtopic = 1
        call expression "ch30_" + str(persistent.current_armstrongtopic)
    jump ch30_loop
    return
...
label ch30_main:
    ...
    $ config.allow_skipping = False
    $ persistent.armstrongtopics = []
    $ persistent.armstrong_reload = 0
    $ persistent.sam_kill = 0
    $ persistent.armstrong_kill = False
    $ renpy.save_persistent()
    $ m.display_args["callback"] = slow_nodismiss
    $ m.what_args["slow_abortable"] = config.developer
    if not config.developer:
        $ style.say_dialogue = style.default_armstrong
    $ m_name = "Armstrong"
    $ delete_all_saves()
    scene white
    play music "bgm/armstrong-start.ogg" noloop
    $ pause(0.5)
    ...
    m "About that whole thing with Sam..."
    ...
    m "Also, the same thing happened with raiden..."
    ...
    m "I thought making raiden more and more depressed would prevent her from confessing to you."
    m "And amplifying Sam's obsessive personality backfired, too..."
...
label ch30_main2:
    ...
    m "And you wouldn't believe how easy it was to delete Bladewolf and Sam."
...
label ch30_end:
    ...
    $ persistent.armstrong_kill = True
    $ renpy.save_persistent()
    $ m.display_args["callback"] = slow_nodismiss
    $ m.what_args["slow_abortable"] = config.developer
    $ style.say_dialogue = style.default_armstrong
...
label ch30_endb:
    ...
    show room_mask2 as rm2:
        ...
        pos (935,200)
    show armstrong_room
    show armstrong_room_highlight
    show armstrong_body_glitch1 as mbg zorder 3
    $ gtext = glitchtext(70)
    m "[gtext]"
    ...
    show room_glitch zorder 2:
        ...
        0.1
        alpha 0
    show armstrong_body_glitch2 as mbg zorder 3
    stop music
    window auto
    m "What's happening...?"
    ...
    $ consolehistory = []
    call updateconsole ("renpy.file(\"characters/armstrong.chr\")", "armstrong.chr does not exist.")
    m "HELP ME!!!"
    show m_rectstatic
    show m_rectstatic2
    show m_rectstatic3
    play sound "sfx/armstrongpound.ogg"
    show layer master:
        truecenter
        parallel:
            zoom 1.5
    ...
    m "DID YOU DELETE ME?"
    $ style.say_window = style.window_armstrong
    play sound "<from 0.69>sfx/armstrongpound.ogg"
    show layer screens:
        truecenter
        parallel:
            zoom 1.5
...
label ch30_autoload:
    ...
    play music m1
    window auto
    if persistent.armstrong_reload <= 4:
        call expression "ch30_reload_" + str(persistent.armstrong_reload)
    else:
        call ch30_reload_4
    $ persistent.armstrong_reload += 1
    $ renpy.save_persistent()
...
label ch30_loop:
    ...
    $ persistent.current_armstrongtopic = 0
    if not persistent.tried_skip:
        $ config.allow_skipping = True
    else:
        $ config.allow_skipping = False
...
label ch30_waitloop:
    ...
    python:
        if len(persistent.armstrongtopics) == 0:
            persistent.armstrongtopics = range(1,57)
            persistent.armstrongtopics.remove(14)
            persistent.armstrongtopics.remove(25)
            persistent.armstrongtopics.remove(26)
            if not persistent.seen_colors_poem:
                persistent.armstrongtopics.remove(27)
        persistent.current_armstrongtopic = random.choice(persistent.armstrongtopics)
        persistent.armstrongtopics.remove(persistent.current_armstrongtopic)
...
label ch30_1:
    ...
    m "And you know what?"
    m "I bet he's still laughing at the miserable fates of raiden and Sam, even as we speak."
...
label ch30_5:
    m "I was thinking about raiden earlier..."
    ...
    m "You know how raiden is really clumsy?"
    ...
    m "I may have exacerbated it a little bit, but raiden was already mentally ill."
    m "Still, though..."
...
label ch30_7:
    ...
    m "I hope being friends with raiden has given you some perspective on the true face of depression."
    m "Yeah, she's gone now..."
    m "But raiden was never real in the first place."
    m "You're real."
...
label ch30_11:
    m "Hey, you know that book you were reading with Sam?"
...
label ch30_13:
    ...
    m "Like, remember how it was for Sam?"
...
label ch30_20:
    ...
    m "Come to think of it, didn't Bladewolf and Sam make fun of me for it once...?"
    m "Well, whatever."
...
label ch30_22:
    ...
    m "Like, imagine if there was someone like Sam in real life."
    m "I mean, she's barely even capable of forming a complete sentence."
    m "And forget about Bladewolf..."
    m "Sheesh."
...
label ch30_23:
    m "Hey, I wonder if Sam's tea set is still somewhere in here..."
    m "...Or maybe that got deleted, too."
    m "It's kind of funny how Sam took her tea so seriously."
...
label ch30_27:
    ...
    m "I mean, the one right before Sam killed herself, with all the messed-up colors and stuff."
...
label ch30_35:
    m "Ehehe. Sam did something really funny once."
    m "We were all in the clubroom and just relaxing, as usual..."
    m "And out of nowhere, Sam just pulled out a small bottle of wine."
    m "I'm not even kidding!"
    m "She was just like 'Would anybody like some wine?'"
    m "Bladewolf laughed out loud, and raiden started yelling at her."
    ...
    m "Though I think Bladewolf was secretly a bit curious to try it..."
...
label ch30_46:
    ...
    m "...Well, I guess that would be Armstrong's Debate Tip of the Day!"
...
label ch30_52:
    ...
    m "I'm sure it's obvious, but Bladewolf was really the embodiment of that."
