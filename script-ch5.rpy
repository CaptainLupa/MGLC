...
label ch5_main:
    ...
    "Of all days, I expected this to be the one where I'd be walking to school with raiden."
    "But raiden isn't answering her phone."
    ...
    if ch4_scene == "bladewolf":
        "I managed to carry all the cupcakes myself by carefully stacking two trays."
        "Bladewolf is already texting up a storm, but I can't respond, thanks to my hands being full."
    else:
        "The banner Sam and I painted is dry, and I gently rolled it up to take with me."
        "She sent me a pleasant text reminding me not to forget anything, and I reassured her."
    "Funnily enough, I probably feel the same way as Bladewolf about the event."
    "I'm more excited for it to be over so I can spend time with raiden and [ch4_name] at the festival."
    "But knowing Armstrong, I'm sure the event will be great, too."
    ...
    mc "That's funny, I thought at least Sam would be here by now."
    "Armstrong is placing little booklets on each of the desks in the classroom."
    "They must be the ones she prepared that have all the poems we're performing."
    "In the end, I found a random poem online that I thought Armstrong would like, and submitted it."
    "So, that's the one I'll be performing."
    m "I'm surprised you didn't bring raiden with you."
    mc "Yeah, she overslept again..."
    mc "That dummy."
    mc "You'd think that on days this important, she'd try a little harder..."
    "I say that, but I suddenly remember what raiden told me yesterday..."
    ...
    mc "Eh...?"
    "Armstrong is being as friendly as usual, but for some reason I felt a chill down my spine after hearing that."
    ...
    "I recognize Bladewolf's and Sam's poems from the ones they performed during our practice."
    mc "What's this...?"
    "I flip to raiden's poem."
    ...
    m "What's wrong?"
    mc "Ah, nothing..."
    "This poem feels completely different from everything else raiden's written."
    "But more than that..."
    mc "I-I changed my mind!"
    mc "I'm going to go get raiden, so..."
    m "Ah--"
    m "Well, alright!"
    ...
    "Armstrong calls that out after me."
    "I quicken my pace."

    scene bg residential_day with wipeleft_scene
    "What was I thinking?"
    "I should have tried a little bit harder for raiden."
    ...
    "I reach raiden's house and knock on the door."
    ...
    "Outside raiden's room, I knock on her door."
    mc "raiden?"
    mc "Wake up, dummy..."
    "There's no response."
    ...
    "Just yesterday..."
    "I told raiden I would be there for her."
    ...
    if raiden_confess:
        ...
        "That's not what raiden needed at all."
